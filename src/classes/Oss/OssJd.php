...
{ 
    ...
    protected function init(){
        ...
        $this->bucket = get_config("JD_BUCKET");
        $credentials = new Credentials(get_config("JD_ACCESS_KEY_ID"), get_config("JD_ACCESS_SECRET"));  
        $this->s3 = new S3Client([
            'version' => 'latest', 
            'endpoint'=> get_config("JD_ENDPOINT"),
            'region'  => get_config("JD_REGION"),
